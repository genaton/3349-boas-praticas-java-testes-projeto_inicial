...
public class ValidacaoTutorComAdocaoEmAndamentoTest {
    ...
    @Test
    @DisplayName("Não Deve permitir a solicitação de adoção de Tutor com adocao em andamento")
    ...
    @Test
    @DisplayName("Deve permitir a solicitação de adoção de Tutor sem adocao em andamento")
